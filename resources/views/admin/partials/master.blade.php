...
<head>
    ...
    @yield('js-custom')  <!-- Cho phép tùy chỉnh JS từ các view con -->

    @include('admin.partials.css')  <!-- Phần CSS tùy chỉnh khác nếu có -->
...
<body id="page-top">
    ...
    @include('admin.partials.js')  <!-- Tải JS tùy chỉnh chung của admin -->

    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.5/dist/js/bootstrap.bundle.min.js" integrity="sha384-k6d4wzSIapyDyv1kpU366/PK5hCdSbCRGRCMv+eplOQJWyd1fbcAu9OCUj5zNLiq" crossorigin="anonymous"></script>
    <script src="../assets/js/admin/check_dish_admin.js"></script>
</body>
